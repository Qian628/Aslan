...
DynamicsBicycleModelWithDelay::DynamicsBicycleModelWithDelay(double &wheelbase, double &steer_tau, double &mass_fl, double &mass_fr,
                                           double &mass_rl, double &mass_rr, double &cf, double &cr)
    : VehicleModelInterface(/* dim_x */ 5, /* dim_u */ 1, /* dim_y */ 2)
{
...
void DynamicsBicycleModelWithDelay::calculateDiscreteMatrix(Eigen::MatrixXd &Ad,
                                                   Eigen::MatrixXd &Bd,
                                                   Eigen::MatrixXd &Cd,
                                                   Eigen::MatrixXd &Wd,
                                                   const double &dt)
...
void DynamicsBicycleModelWithDelay::calculateReferenceInput(Eigen::MatrixXd &Uref)
{
    const double vel = std::max(velocity_, 0.01);
